...
<FAQSchema questions={[
  {
    question: "What is the difference between ADHD perfectionism and OCD?",
    answer: "ADHD perfectionism stems from executive dysfunction defense (fear of failure leads to task avoidance); OCD involves high anxiety and compulsive, ritualistic behaviors."
  },
  {
    question: "If I keep lowering my standards, won't I just become lazy and fail?",
    answer: "No. It's about selective laziness. Being lazy about laundry lets you save energy to be great at your core work or hobbies. It's energy management, not quitting."
  },
  {
    question: "What if I break tasks down but still can't start the first step?",
    answer: "Your battery is likely at 0%. Forcing it only increases anxiety. Accept the crash and rest without guilt. True rest is how you recover dopamine."
  }
]} />
